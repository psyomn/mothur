...
class GetSeqsCommand : public Command {
	...
	public:
        ...
        GetSeqsCommand(unordered_map<string, vector<int> >, string fastafile, vector<string> outputFiles, vector<string> groups);
		~GetSeqsCommand(){}
	...
	private:
        ...
        void readFasta(unordered_map<string, vector<int> > nameToGroups, string fastafile, vector<string> outputFiles, vector<string>);
